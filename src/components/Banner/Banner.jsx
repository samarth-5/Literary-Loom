    ...
    <>
      <div className='py-10'>
        <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 items- gap-6">
                ...
                <div data-aos="slide-up" className='flex flex-col justify-center gap-6 sm:pt-0'>
                    ...
                    <p className='text-sm text-gray-500 tracking-wide leading-5'>
                        ...
                        Soluta rerum, sequi veritatis tenetur magni maxime optio 
                        aperiam accusamus, magnam quis facilis, commodi reiciendis? 
                        Quos modi id mollitia sit dolore porro?
                    </p>
